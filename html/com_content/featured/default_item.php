...
<?php if ($params->get('show_print_icon') || $params->get('show_email_icon') || $canEdit) : ?>
    <div class="btn-group pull-right"> <a class="btn dropdown-toggle" data-toggle="dropdown" href="#" role="button"> <span class="icon-align-justify"></span><span class="caret"></span> </a>
...
<?php endif; ?>
    ...
    <div class="page-header">
        <h2 class="item-title h3 no-margin-top">
    ...
    <?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
        ...
        <div class="item-image pull-<?php echo htmlspecialchars($imgfloat); ?>"> 
            <div class="img-wrapper">
                <a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid)); ?>">
                    <img class="img-responsive <?php if ($images->image_intro_caption): echo 'caption'.'" title="' .htmlspecialchars($images->image_intro_caption); endif; ?>"

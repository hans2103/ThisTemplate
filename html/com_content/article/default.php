...
?>
    ...
    <?php if ($useDefList && ($info == 0 || $info == 2)) : ?>
        <div class="article-info muted">
            ...
            <?php if(false) : ?><dt class="article-info-term"><?php echo JText::_('COM_CONTENT_ARTICLE_INFO'); ?></dt><?php endif; ?>
    ...
    <div class="pull-<?php echo htmlspecialchars($imgfloat); ?> item-image"> 
        <img class="img-responsive <?php if ($images->image_fulltext_caption): echo 'caption'.'" title="' .htmlspecialchars($images->image_fulltext_caption);endif; ?>"
